        ...
        if(currency >= 0):
            ...
            if(item_type != 6):
                if(item_type == 1):
                    ...
                    print('YOU DO NOT HAVE ENOUGH CURRENCY FOR THAT ITEM. PLEASE RESTART THE ITEM SHOP')
                    itemShop()
        else:
            print('-------------------------------------------------------------------------------------------')
    ...
    if(enter == ''):
        while(casts <= 5 and points < 25):
            ...
            if(total >= 0 and total <= 21):
                ...
                if(cast >= 31 and cast <= 50):
                    points += cast
                    print('--------------------------------------------------------------------------------------------')
                    print('CAST #', casts)
                    print('CONGRATS! YOU JUST CAUGHT A', cast, 'POUND MUSKY')
                    print('Point Total', points)
                    print('--------------------------------------------------------------------------------------------')
            else:
                pass
...
'''
    if(casts == 5):
        if(points >= 25):
            ...
            pass
            #print('YOU UNFOURTUNATELY WERE NOT ABLE TO COMPLETE THE LEVEL, PLEASE TRY AGAIN!')
            #fishingLevel(total)
'''
